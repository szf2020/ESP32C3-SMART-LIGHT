...
<a href="#" onclick='helpFunction()'>help</a>

</div></div>
<div id='msect'><h2>MOSQUITTO SETTINGS</h2></div>
<div id='msect'>
  <div class='divstijl'>
  <center>
  <form id='formulier' method='get' action='submitform' oninput='showSubmit();'>
  
  <table><tr><td style='width:70px;'>format:&nbsp<td><select name='fm' class='sb1' id='sel'>
  ...
  <tr><td>intopic:&nbsp<td><input class='inp6' name='mqtinTopic' value='{mqttinTopic}' length='60'></tr>
