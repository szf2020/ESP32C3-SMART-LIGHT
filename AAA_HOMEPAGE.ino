...
var url = "/submitform?pwmsave=" + pwm;
...
function sliderUpdate() {
  ...
  //var url = "/sliderPos?sldr=" + sldrPos;
  var url = "/get.Data?sldr=" + sldrPos;
  xhttp.open("GET", url, true);
  xhttp.send();
...
function getData() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      //var maxDuty=obj.maxduty;
      //console.log("maxDuty = " + maxDuty);
      document.getElementById("duty").max=obj.maxduty;
      //document.getElementById("duty").max=maxDuty;
      document.getElementById("duty").value=obj.duty;
      document.getElementById("demoLPM").innerHTML=obj.duty;
      document.getElementById("NAME").innerHTML=obj.name;
      console.log("duty = " + duty);
      //var max=document.getElementById("duty").max;
      //console.log("max = " + max);
      if (obj.duty == "0") {
        btn.checked=false;
        // if the dutyvalue 256 we hide the savebutton
        btn2.style.display="none";
      } else {
        btn.checked=true;
        btn2.style.display="block";
  ...
  xhttp.open("GET", "get.Data?subj=home", true);
  xhttp.send();
}
